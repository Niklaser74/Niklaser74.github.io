...
const dict = {
  sv: {
    ...
    'hero.more': 'Alla spel',
    'games.title': 'Spelen',
    'games.lead': 'Ett spel är spelbart, resten kryper hitåt. Samma sniglar i alla, ritade av samma kod.',
    ...
    'g3.text': 'Schack med Snäckmageddons sniglar och vapen. Reglerna bestämmer vem som får slå vem, slaget avgörs i en liten duell. Eller snällt schack utan skjutande, för den som vill.',
  ...
  en: {
    ...
    'games.lead': 'One game is playable, the rest are crawling this way. The same snails in all of them, drawn by the same code.',
    ...
    'g3.text': 'Chess with the Snailmageddon snails and weapons. The rules decide who may capture whom; the capture is settled in a little duel. Or gentle chess with no shooting, if you prefer.',
    'g4.title': 'Snail Story',
