...
const dict = {
  sv: {
    ...
    'g3.title': 'Snail Racing',
    'g3.text': 'Ett lopp tar tjugo minuter i realtid. Satsa på din snigel, gör något annat och få en notis när det avgörs.',
  ...
  en: {
    ...
    'g3.title': 'Snail Racing',
    'g3.text': 'A race takes twenty minutes in real time. Bet on your snail, go do something else and get a notification when it is decided.',
    'g4.title': 'Snail Story',
