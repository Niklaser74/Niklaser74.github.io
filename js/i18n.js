...
const dict = {
  sv: {
    ...
    'g6.text': 'Tre i rad, och luffarschack på stort bräde. Sniglarna kryper till sin ruta och lämnar slem bakom sig — och slemmet räknas som en halv markör. Spelidé: Katie Norling.',
    'g6.tag1': 'Tre i rad', 'g6.tag2': 'Fem i rad', 'g6.tag3': 'Slemspår', 'g6.tag4': 'Funkar offline', 'g6.play': 'Spela',
  ...
  en: {
    ...
    'g6.text': 'Noughts and crosses, and five in a row on a big board. The snails crawl to their square and leave slime behind them — and the slime counts as half a marker. Game design by Katie Norling.',
    'g6.tag1': 'Three in a row', 'g6.tag2': 'Five in a row', 'g6.tag3': 'Slime trail', 'g6.tag4': 'Works offline', 'g6.play': 'Play',
