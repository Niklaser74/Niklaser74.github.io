...
const dict = {
  sv: {
    ...
    'acc.confirm': 'Bekräfta', 'acc.confirmHint': 'Tryck på Bekräfta för att logga in med länken.', 'acc.unsolicited': 'Den här länken hörde inte till någon inloggning du påbörjade här. Ingenting gjordes — börja om från den här sidan om du vill logga in.',
  ...
  en: {
    ...
    'acc.confirm': 'Confirm', 'acc.confirmHint': 'Press Confirm to sign in with the link.', 'acc.unsolicited': 'This link did not belong to a sign-in you started here. Nothing was done — start again from this page if you want to sign in.',
