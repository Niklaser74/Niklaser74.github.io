...
const dict = {
  sv: {
    ...
    'g6.text': 'Tre spel i ett. Tre i rad där du bara har tre sniglar och flyttar dem vidare; luffarschack där slemspåret räknas som en halv markör; och en kapplöpning utan turordning, där sniglarna kryper i kapp om rutorna. Spelidé: Katie Norling.',
    'g6.tag1': 'Tre i rad', 'g6.tag2': 'Luffarschack', 'g6.tag3': 'Kryp i kapp', 'g6.tag4': 'Funkar offline', 'g6.play': 'Spela',
  ...
  en: {
    ...
    'g6.text': 'Three games in one. Noughts and crosses where you only have three snails and move them on; five in a row where the slime trail counts as half a marker; and a race with no turns at all, where the snails crawl each other for the squares. Game design by Katie Norling.',
    'g6.tag1': 'Three in a row', 'g6.tag2': 'Five in a row', 'g6.tag3': 'A crawling race', 'g6.tag4': 'Works offline', 'g6.play': 'Play',
