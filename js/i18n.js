...
const dict = {
  sv: {
    ...
    'hero.more': 'Alla spel',
    'games.title': 'Spelen',
    'games.lead': 'Fyra spel är spelbara, resten kryper hitåt. Samma sniglar i alla, ritade av samma kod.',
    ...
    'g5.text': 'Du är trädgårdsmästaren. Sätt ner sniglar med en kratta som bara går åt ett håll per knapp. Likadana växer ihop, tre på varandra är slut — och lasten kryper om du dröjer. Spelidé: Katie Norling.',
    'g5.tag1': 'Klomaskin', 'g5.tag2': 'Fem nivåer', 'g5.tag3': 'Funkar offline', 'g5.play': 'Spela',
  ...
  en: {
    ...
    'games.lead': 'Four games are playable, the rest are crawling this way. The same snails in all of them, drawn by the same code.',
    ...
    'g5.title': 'Snail Rake',
    'g5.text': 'You are the gardener. Put snails down with a rake that only goes one way per button. Matching snails grow together, three in a stack is the end — and the cargo crawls off if you dawdle. Game design by Katie Norling.',
    'g5.tag1': 'Claw machine', 'g5.tag2': 'Five levels', 'g5.tag3': 'Works offline', 'g5.play': 'Play',
